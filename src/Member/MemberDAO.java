...
public class MemberDAO {
	...
	public void UpdateMember(MemberDTO dto) {
		String SQL = "UPDATE tbl_member SET name = ?, birth = ?, gen = ?, phone = ? where id = ?";
		try {
	...
	public int RegistrationMember(MemberDTO dto) {
		String SQL = "insert into tbl_member (name, birth, gen, phone) values (?, ?, ?, ?)";
	...
	public int phoneCheck(String phone) {
		...
		try {
			...
			pstmt.setInt(1, Integer.parseInt(phone));
